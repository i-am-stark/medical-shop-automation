...
urlpatterns=[
    ...
    path('admin_user/orders/', HODViews.order_list, name='order_list'),
    ...
    path('admin_user/out_of_stock/',HODViews.outOfStock,name='out_of_stock'),
    path('admin_user/expired_drugs/', HODViews.expiredDrugs, name='expired_drugs'),
